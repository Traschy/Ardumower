...
Mower::Mower(){
  ...
  // ------ perimeter ---------------------------------
  perimeterUse               = 1;          // ge�ndert thorsten use perimeter?    
  ...
  MaxSpeedperiPwm = 170; //ge�ndert thorsten 200 speed max in PWM while perimeter tracking
  // ------ lawn sensor --------------------------------
  lawnSensorUse     = 0;                   // use capacitive lawn Sensor
  
  // ------  IMU (compass/accel/gyro) ----------------------
  imuUse                     = 1;          // ge�ndert thorsten use IMU?
  ...
  esp8266ConfigString        = "config:FRITZBox,55970298204784759429,192.168.178.90,192.168.178.1,255.255.255.0"; // geändert Thorsten
