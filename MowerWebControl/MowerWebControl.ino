// Versionsinfo: Kann jetzt mit esp8266 Lib version 2.7.1 und Spiffs 0.5 Compeliert werden
// HTML daten korrigiert
//timer voll funktionsfähig
// GPS UPDATE
// Mähzonenupdate
...
char *ssid = "FRITZBox";
char *password = "55970298204784759429";
...
void setup() {
  ...
  delay(500);
  Serial.println("\n\n");
  Serial.println(MSG_HEADER " ESP8266 Serial WIFI Bridge with Webinterface " VESRION);
